...
# OpenClash Provider Cache Guard v3.1.3
# Dynamic Airport-* provider detection
# Add invalid provider protection

CACHE_DIR="/etc/openclash/proxy_provider"

STATE_FILE="/etc/openclash/provider-cache-v3.1.3.sha256"

LOG_FILE="/tmp/provider-cache-guard-v3.1.3.log"
